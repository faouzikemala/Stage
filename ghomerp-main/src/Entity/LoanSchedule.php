...
class LoanSchedule
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="fk_payment_loan", type="integer", nullable=true)
     */
    private $fkPaymentLoan;
    ...
    public function getFkPaymentLoan(): ?int
    {
        return $this->fkPaymentLoan;
    }

    public function setFkPaymentLoan(?int $fkPaymentLoan): self
    {
        $this->fkPaymentLoan = $fkPaymentLoan;
