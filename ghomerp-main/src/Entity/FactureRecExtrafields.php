...
/**
 * FactureRecExtrafields
 *
 * @ORM\Table(name="facture_rec_extrafields", indexes={@ORM\Index(name="idx_facture_rec_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class FactureRecExtrafields
{
    /**
     * @var int
     *
