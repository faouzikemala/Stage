 ...
 * FacturedetRec
 *
 * @ORM\Table(name="facturedet_rec", indexes={@ORM\Index(name="fk_facturedet_rec_fk_unit", columns={"fk_unit"})})
 * @ORM\Entity
 */
class FacturedetRec
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="date_start_fill", type="integer", nullable=true)
     */
    private $dateStartFill = '0';

    /**
     * @var int|null
     *
     * @ORM\Column(name="date_end_fill", type="integer", nullable=true)
     */
    private $dateEndFill = '0';
    ...
    public function getDateStartFill(): ?int
    {
        return $this->dateStartFill;
    }

    public function setDateStartFill(?int $dateStartFill): self
    {
        $this->dateStartFill = $dateStartFill;

        return $this;
    }

    public function getDateEndFill(): ?int
    {
        return $this->dateEndFill;
    }

    public function setDateEndFill(?int $dateEndFill): self
    {
        $this->dateEndFill = $dateEndFill;
