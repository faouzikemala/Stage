...
/**
 * AdherentTypeExtrafields
 *
 * @ORM\Table(name="adherent_type_extrafields", indexes={@ORM\Index(name="idx_adherent_type_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class AdherentTypeExtrafields
{
    /**
     * @var int
     *
