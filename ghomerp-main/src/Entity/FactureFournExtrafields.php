...
/**
 * FactureFournExtrafields
 *
 * @ORM\Table(name="facture_fourn_extrafields", indexes={@ORM\Index(name="idx_facture_fourn_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class FactureFournExtrafields
{
    /**
     * @var int
     *
