...
/**
 * CommandedetExtrafields
 *
 * @ORM\Table(name="commandedet_extrafields", indexes={@ORM\Index(name="idx_commandedet_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class CommandedetExtrafields
{
    /**
     * @var int
     *
