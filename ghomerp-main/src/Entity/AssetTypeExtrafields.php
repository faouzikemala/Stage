...
/**
 * AssetTypeExtrafields
 *
 * @ORM\Table(name="asset_type_extrafields", indexes={@ORM\Index(name="idx_asset_type_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class AssetTypeExtrafields
{
    /**
     * @var int
     *
