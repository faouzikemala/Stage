 ...
 *
 * @ORM\Table(name="accounting_bookkeeping", indexes={@ORM\Index(name="idx_accounting_bookkeeping_fk_docdet", columns={"fk_docdet"}), @ORM\Index(name="idx_accounting_bookkeeping_numero_compte", columns={"numero_compte", "entity"}), @ORM\Index(name="idx_accounting_bookkeeping_code_journal", columns={"code_journal", "entity"}), @ORM\Index(name="idx_accounting_bookkeeping_piece_num", columns={"piece_num", "entity"}), @ORM\Index(name="idx_accounting_bookkeeping_fk_doc", columns={"fk_doc"}), @ORM\Index(name="idx_accounting_bookkeeping_doc_date", columns={"doc_date"})})
 * @ORM\Entity
 */
class AccountingBookkeeping
{
     ...
     * @var float|null
     *
     * @ORM\Column(name="montant", type="float", precision=24, scale=8, nullable=true)
     */
    private $montant;
