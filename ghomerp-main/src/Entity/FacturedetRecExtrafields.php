...
/**
 * FacturedetRecExtrafields
 *
 * @ORM\Table(name="facturedet_rec_extrafields", indexes={@ORM\Index(name="idx_facturedet_rec_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class FacturedetRecExtrafields
{
    /**
     * @var int
     *
