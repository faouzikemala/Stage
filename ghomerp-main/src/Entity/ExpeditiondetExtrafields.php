...
/**
 * ExpeditiondetExtrafields
 *
 * @ORM\Table(name="expeditiondet_extrafields", indexes={@ORM\Index(name="idx_expeditiondet_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class ExpeditiondetExtrafields
{
    /**
     * @var int
     *
