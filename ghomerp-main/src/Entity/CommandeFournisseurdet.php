...
/**
 * CommandeFournisseurdet
 *
 * @ORM\Table(name="commande_fournisseurdet", indexes={@ORM\Index(name="idx_commande_fournisseurdet_fk_commande", columns={"fk_commande"}), @ORM\Index(name="fk_commande_fournisseurdet_fk_unit", columns={"fk_unit"}), @ORM\Index(name="idx_commande_fournisseurdet_fk_product", columns={"fk_product"})})
 * @ORM\Entity
 */
