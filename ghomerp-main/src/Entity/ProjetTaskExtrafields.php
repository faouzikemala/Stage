...
/**
 * ProjetTaskExtrafields
 *
 * @ORM\Table(name="projet_task_extrafields", indexes={@ORM\Index(name="idx_projet_task_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class ProjetTaskExtrafields
{
    /**
     * @var int
     *
