 ...
 * Reception
 *
 * @ORM\Table(name="reception", uniqueConstraints={@ORM\UniqueConstraint(name="idx_reception_uk_ref", columns={"ref", "entity"})}, indexes={@ORM\Index(name="idx_reception_fk_user_author", columns={"fk_user_author"}), @ORM\Index(name="idx_reception_fk_shipping_method", columns={"fk_shipping_method"}), @ORM\Index(name="idx_reception_fk_user_valid", columns={"fk_user_valid"}), @ORM\Index(name="idx_reception_fk_soc", columns={"fk_soc"})})
 * @ORM\Entity
 */
class Reception
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="ref_ext", type="string", length=30, nullable=true)
     */
    private $refExt;
     ...
     * @var string|null
     *
     * @ORM\Column(name="ref_int", type="string", length=30, nullable=true)
     */
    private $refInt;
     ...
     * @var string|null
     *
     * @ORM\Column(name="ref_supplier", type="string", length=30, nullable=true)
     */
    private $refSupplier;
