...
/**
 * PaymentSalaryExtrafields
 *
 * @ORM\Table(name="payment_salary_extrafields", indexes={@ORM\Index(name="idx_payment_salary_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class PaymentSalaryExtrafields
{
    /**
     * @var int
     *
