 ...
 * FactureFournDet
 *
 * @ORM\Table(name="facture_fourn_det", uniqueConstraints={@ORM\UniqueConstraint(name="uk_fk_remise_except", columns={"fk_remise_except", "fk_facture_fourn"})}, indexes={@ORM\Index(name="fk_facture_fourn_det_fk_unit", columns={"fk_unit"}), @ORM\Index(name="idx_facture_fourn_det_fk_product", columns={"fk_product"}), @ORM\Index(name="idx_facture_fourn_det_fk_facture", columns={"fk_facture_fourn"}), @ORM\Index(name="idx_facture_fourn_det_fk_code_ventilation", columns={"fk_code_ventilation"})})
 * @ORM\Entity
 */
class FactureFournDet
{
     ...
     * @var \FactureFourn
     *
     * @ORM\ManyToOne(targetEntity="FactureFourn")
     * @ORM\JoinColumns({
    ...
    public function getFkFactureFourn(): ?FactureFourn
    {
        return $this->fkFactureFourn;
    }

    public function setFkFactureFourn(?FactureFourn $fkFactureFourn): self
    {
