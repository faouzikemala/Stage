...
/**
 * FichinterdetExtrafields
 *
 * @ORM\Table(name="fichinterdet_extrafields", indexes={@ORM\Index(name="idx_ficheinterdet_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class FichinterdetExtrafields
{
    /**
     * @var int
     *
