...
/**
 * ActioncommExtrafields
 *
 * @ORM\Table(name="actioncomm_extrafields", indexes={@ORM\Index(name="idx_actioncomm_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class ActioncommExtrafields
{
    /**
     * @var int
     *
