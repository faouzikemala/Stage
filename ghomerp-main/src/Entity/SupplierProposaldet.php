 ...
 * SupplierProposaldet
 *
 * @ORM\Table(name="supplier_proposaldet", indexes={@ORM\Index(name="idx_supplier_proposaldet_fk_product", columns={"fk_product"}), @ORM\Index(name="idx_supplier_proposaldet_fk_supplier_proposal", columns={"fk_supplier_proposal"}), @ORM\Index(name="fk_supplier_proposaldet_fk_unit", columns={"fk_unit"})})
 * @ORM\Entity
 */
class SupplierProposaldet
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="SupplierProposal")
     * @ORM\JoinColumns({
    ...
    public function getFkSupplierProposal(): ?SupplierProposal
    {
        return $this->fkSupplierProposal;
    }

    public function setFkSupplierProposal(?SupplierProposal $fkSupplierProposal): self
    {
        $this->fkSupplierProposal = $fkSupplierProposal;
