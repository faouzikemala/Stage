...
/**
 * FichinterExtrafields
 *
 * @ORM\Table(name="fichinter_extrafields", indexes={@ORM\Index(name="idx_ficheinter_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class FichinterExtrafields
{
    /**
     * @var int
     *
