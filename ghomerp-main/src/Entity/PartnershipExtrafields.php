...
/**
 * PartnershipExtrafields
 *
 * @ORM\Table(name="partnership_extrafields", indexes={@ORM\Index(name="idx_partnership_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class PartnershipExtrafields
{
    /**
     * @var int
     *
