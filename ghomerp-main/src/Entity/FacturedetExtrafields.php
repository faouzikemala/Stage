...
/**
 * FacturedetExtrafields
 *
 * @ORM\Table(name="facturedet_extrafields", indexes={@ORM\Index(name="idx_facturedet_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class FacturedetExtrafields
{
    /**
     * @var int
     *
