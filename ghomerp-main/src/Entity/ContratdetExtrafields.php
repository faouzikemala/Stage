...
/**
 * ContratdetExtrafields
 *
 * @ORM\Table(name="contratdet_extrafields", indexes={@ORM\Index(name="idx_contratdet_extrafields", columns={"fk_object"})})
 * @ORM\Entity
 */
class ContratdetExtrafields
{
    /**
     * @var int
     *
